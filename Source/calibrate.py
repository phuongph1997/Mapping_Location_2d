...
if __name__ == '__main__':
    ...
    #calibration = dict(rms=rms, camera_matrix=camera_matrix.tolist(), dist_coefs=dist_coefs.tolist())
    with open(args.out, 'w') as fw:
        yaml.dump(calibration, fw)

#./calibrate.py /home/minhnd/video2calibration/data/output.avi calibration.yaml --debug-dir out
